...
import torchinfo
import tqdm
from EasyTSAD.Methods import BaseMethod, LSTMADalpha, LSTMADbeta
...
class LSTMADalpha_resilientbackprop(BaseMethod):
    def __init__(self, params:dict) -> None:
        ...
        # changed the optimizer Rprop (Resilient Backprop instead of ADAM)
        self.optimizer = optim.Rprop(self.model.parameters(), lr=lr)
        # LR scheduler is not used for Rprop due to adaptive step sizes for each parameter
